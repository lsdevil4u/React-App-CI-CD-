    ...
    const handleDeleteGatedConetnt = () => {
        dispatch(deleteGatedContent(gated_content_id))
            .then((res) => {
                ...
                Swal.fire({
                    icon: 'info',
                    text: `Gated Content Deleted Successfully`,
                    color: 'white',
                    background: '#120E16',
                    ...
                    <div className='col'>
                        <div className='details-heading'>
                            ...
                            <div className='details-heading-actions'>
                                <button onClick={handleDeleteGatedConetnt} className='delete-content'>DELETE CONTENT</button>
                                {/* <button className='share-content'>SHARE CONTENT</button> */}
                                ...
                                <div onClick={copyToClipBoard} >
                                    {
                                        !copied ?
                                            ...
                                            :
                                            <button className='copy-link'>COPIED</button>
