      ...
      <div className='container-fluid onboarding_page'>
        ...
        <div className='row onboard-flow pl-0'>
          <div className='col pl-0'>
            <div className='sign-text mt-3'>Oboarding</div>
              ...
              <div>
                ...
                <div className='mt-3'>
                  <span className='user-check' id='username'>
                    {checkU?.response?.available === true && (
                      <i className="fa fa-check"></i>
                    )}
                    {checkU?.response?.available === false && (
                  ...
                  <InputText
                    ...
                    value={userName}
                    errorMessage="Username minimum of three characters"
                    required="true"
