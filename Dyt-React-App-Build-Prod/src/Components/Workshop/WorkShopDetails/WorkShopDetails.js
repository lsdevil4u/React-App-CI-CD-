                                ...
                                <div className='card-body'>
                                    ...
                                    <div className='deatils-page-cover'>
                                        ...
                                        {(Moment(new Date()).isSameOrAfter(Moment(datum.start_date)))
                                            ...
                                            // <></>
                                            :
                                            (datum.is_host || (Math.abs(Moment(new Date()).diff(Moment(datum.start_date), 'minutes')) <= 0 && datum.is_registered)) ?
                                                <a href={datum.webinar_link} target="_blank"><div className='main-card-image book-now'>  Join </div></a>
                                                :
                                                datum.is_registered ?
                                                    <div className='main-card-image book-now'>Joining link will be visible 30 Min Before the Workshop</div>
